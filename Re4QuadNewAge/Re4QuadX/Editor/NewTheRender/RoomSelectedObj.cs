...
namespace NewAgeTheRender
{
    public class RoomSelectedObj
    {
        ...
        private void Load(RoomModel roomModel)
        {
            ...
            switch (roomModel){
                case RoomModel2007 roomModel2007:
                    Load2007(roomModel2007);
                    break;
                case RoomModelPs2 roomModelPS2:
                    LoadPS2(roomModelPS2);
                    break;
                case RoomModelR100Uhd roomModelR100Uhd:
                    LoadR100UHD(roomModelR100Uhd);
                    break;
                case RoomModelUhd roomModelUhd:
        ...
        private void Load2007(RoomModel2007 roomModel2007) 
        {
            ...
            RE4_2007_MODEL_VIEWER.Editor.LoadScenarioSMD loadScenarioSMD = new RE4_2007_MODEL_VIEWER.Editor.LoadScenarioSMD(modelGroup, sng);
            loadScenarioSMD.LoadScenario(smdPath);

            JADERLINK_MODEL_VIEWER.Editor.LoadSMX loadSMX = new JADERLINK_MODEL_VIEWER.Editor.LoadSMX(modelGroup, sng);
        ...
        private void LoadPS2(RoomModelPs2 roomModelPS2)
        {
            ...
            RE4_PS2_MODEL_VIEWER.Editor.LoadPs2ScenarioSMD loadScenarioSMD = new RE4_PS2_MODEL_VIEWER.Editor.LoadPs2ScenarioSMD(modelGroup, sng);
        ...
        private void LoadUHD(RoomModelUhd roomModelUhd)
        {
            ...
            LoadUhdPs4Ns.Editor.LoadUhdScenarioSMD loadScenarioSMD = new LoadUhdPs4Ns.Editor.LoadUhdScenarioSMD(modelGroup, sng, IsPS4NS);
            loadScenarioSMD.ExternalAddTreatedModel = extraContainer.AddTreatedModel;
            loadScenarioSMD.LoadScenario(smdPath);
