...
namespace Re4QuadExtremeEditor.Editor.Controls
{
    public partial class ObjectMoveControl : UserControl
    {
        ...
        private bool moveObjSquare_mouseDown = false;
        private bool moveObjVertical_mouseDown = false;
        private bool moveObjHorisontal1_mouseDown = false;
        private bool moveObjHorisontal2_mouseDown = false;
        private bool moveObjHorisontal3_mouseDown = false;
        ...
        private void moveObjSquare_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                ObjectControl.PerformMove(MoveControlType.Square, e);
            }
        }
        ...
        private void moveObjVertical_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                ObjectControl.PerformMove(MoveControlType.Vertical, e);
            }
        }
        ...
        private void moveObjHorizontal1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                ObjectControl.PerformMove(MoveControlType.Horizontal1, e);
            }
        }
        ...
        private void moveObjHorizontal2_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                ObjectControl.PerformMove(MoveControlType.Horizontal2, e);
            }
        }
        ...
        private void moveObjHorizontal3_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                ObjectControl.PerformMove(MoveControlType.Horizontal3, e);
            }
        }
