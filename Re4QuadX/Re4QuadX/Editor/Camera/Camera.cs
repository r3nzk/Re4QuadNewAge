...
// e em https://github.com/opentk/LearnOpenTK/blob/master/Common/Camera.cs
{
    ...
    public class Camera
    {
        ...
        public void updateCameraToUp(float deltaTime)
        {
            pos += _up * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Up
        }

        public void updateCameraToDown(float deltaTime)
        {
            pos -= _up * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Down
        }

        public void updateCameraToRight(float deltaTime)
        {
            pos += _right * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Right
        }

        public void updateCameraToLeft(float deltaTime)
        {
            pos -= _right * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Left
        }

        public void updateCameraToFront(float deltaTime)
        {
            pos += _front * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Forward 
        }

        public void updateCameraToBack(float deltaTime)
        {
            pos -= _front * (camSpeedMultiplier * 75 * camExtraSpeed) * deltaTime; // Backwards
        }
